	...
	\begin{multline}
		I(\location{r},\omega) = e^{-\tau(\location{r},\location{r}-s\,\omega)} I(\location{r}-s\,\omega,\omega) + \int_{s'=0}^s e^{-\tau(\location{r},\location{r}-s'\,\omega)} \;\cdot \\
