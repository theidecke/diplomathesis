...
\begin{document}
	...
	\end{multline}
	beziehungsweise (mit den in Abschnitt \ref{subsec:nomenklatur} eingef"uhrten Schreibweisen) noch kompakter:
	\begin{equation}
	...
	\begin{itemize}
		...
		\item{Die L"osung ist ein reines Integrationsproblem und somit ein gutes Gegenst"uck zu hochdimensionalen Monte--Carlo--Integrations--Verfahren}
	\end{itemize}
